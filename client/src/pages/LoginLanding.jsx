...
import { ShieldCheckIcon, UserIcon, ArrowRightIcon } from "@heroicons/react/24/outline"
      ...
      justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mb-10 text-center md:text-left">
              <h2 className="text-3xl font-medium text-scale-900 tracking-tight mb-3">Welcome Back</h2>
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
              <p>© {new Date().getFullYear()} GreatStack. All
              rights reserved.</p>
          </div>
        </div>
      </div>
