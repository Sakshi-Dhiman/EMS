...
export const inngest = new Inngest({ id: "sakshi-s-ems"});
...
//Sends email to admin, if admin doesn't take action on leave application within 24 hours
...
const attendanceReminderCron = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    // Step 3: get employee IDs on approval leave today
